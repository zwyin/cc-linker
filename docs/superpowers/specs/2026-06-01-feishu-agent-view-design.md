...
**日期：** 2026-06-06(v2 / v2.1 / v2.2 均为 2026-06-06 同日 review 迭代;v2.2.1 / v2.2.2 / v2.2.3 / v2.2.4 / v2.2.5 为 2026-06-07 hotfix)
**版本：** v2.2.5
**状态：** v2.2.5 已批准(Completed 精确过滤 + name fallback)
**作者：** Claude Code
